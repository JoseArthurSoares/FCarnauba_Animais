<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserControlBenfeitoria.ascx.cs" Inherits="FCarnauba_Animais.UserControls.UserControlBenfeitoria" %>
...
<asp:Panel ID="pnlFields" runat="server">
    <fieldset class="cadastrar_info">
        <legend><font face="Verdana,Arial,sans-serif" color="black"><b>Benfeitoria&nbsp;&nbsp;</b></font></legend>
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataBenfeitoria" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
                 <asp:customvalidator id="cvDataBenfeitoria" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvDataBenfeitoria_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
            <tr>
                <td width="20%" class="rotulo">
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtAreaBenfeitoria" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static"></asp:TextBox>
                    <span class="style1">(Informar apenas números, separar os decimais por vírgula (não usar pontos como separadores).)</span></div>
                    <asp:customvalidator id="cvAreaBenfeitoria" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvAreaBenfeitoria_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
        </table>
    </fieldset>
...
<div align="right"><a href="./CadastrarEstruturaPropriedade.aspx?estruturaPropriedadeId=<%=EstruturaPropriedadeId%>&tabIndex=Benfeitorias" id="EditarB" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
<asp:GridView ID="gridViewBenfeitorias" runat="server" 
...
BorderColor="#156AE9" BorderStyle="Solid" BorderWidth="1px" CssClass="gvclass">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Ações">
            <ItemTemplate>
                <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaBenfeitoria" 
                    NavigateUrl='<%# "~/EditaBenfeitoria.aspx?estruturaPropriedadeId=" + Request.QueryString["EstruturaPropriedadeId"] + "&b=" + DataBinder.Eval(Container.DataItem,"Id")  %>' />
                <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteEstruturaPropriedadeBenfeitoria" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteEstruturaPropriedadeBenfeitoria_Click" OnClientClick="javascript:return perguntaa();" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
