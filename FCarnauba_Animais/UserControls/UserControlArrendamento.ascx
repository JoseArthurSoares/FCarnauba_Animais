<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserControlArrendamento.ascx.cs" Inherits="FCarnauba_Animais.UserControls.UserControlArrendamento" %>
...
<asp:Panel ID="pnlFields" runat="server">
    <fieldset class="cadastrar_info">
        <legend><font face="Verdana,Arial,sans-serif" color="black"><b>Arrendamento&nbsp;&nbsp;</b></font></legend>
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataArrendamento" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
                 <asp:customvalidator id="cvDataArrendamento" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvDataArrendamento_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
            <tr>
                <td width="20%" class="rotulo">
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtAreaArrendamento" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static"></asp:TextBox>
                    <span class="style1">(Informar apenas números, separar os decimais por vírgula (não usar pontos como separadores).)</span></div>
                    <asp:customvalidator id="cvAreaArrendamento" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvAreaArrendamento_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
        </table>
    </fieldset>
...
<div align="right"><a href="./CadastrarEstruturaPropriedade.aspx?estruturaPropriedadeId=<%=EstruturaPropriedadeId%>&tabIndex=Arrendamentos" id="EditarArr" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
<asp:GridView ID="gridViewArrendamentos" runat="server" 
...
BorderColor="#156AE9" BorderStyle="Solid" BorderWidth="1px" CssClass="gvclass">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Ações">
            <ItemTemplate>
                <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaArrendamento" 
                    NavigateUrl='<%# "~/EditaArrendamento.aspx?estruturaPropriedadeId=" + Request.QueryString["EstruturaPropriedadeId"] + "&arr=" + DataBinder.Eval(Container.DataItem,"Id")  %>' />
                <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteEstruturaPropriedadeArrendamento" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteEstruturaPropriedadeArrendamento_Click" OnClientClick="javascript:return perguntaa();" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
