<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserControlAgricultura.ascx.cs" Inherits="FCarnauba_Animais.UserControls.UserControlAgricultura" %>
...
<asp:Panel ID="pnlFields" runat="server">
    <fieldset class="cadastrar_info">
        <legend><font face="Verdana,Arial,sans-serif" color="black"><b>Agricultura&nbsp;&nbsp;</b></font></legend>
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataAgricultura" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
                 <asp:customvalidator id="cvDataAgricultura" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvDataAgricultura_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
            <tr>
                <td width="20%" class="rotulo">
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtAreaAgricultura" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static"></asp:TextBox>
                    <span class="style1">(Informar apenas números, separar os decimais por vírgula (não usar pontos como separadores).)</span></div>
                    <asp:customvalidator id="cvAreaAgricultura" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvAreaAgricultura_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
        </table>
    </fieldset>
...
<div align="right"><a href="./CadastrarEstruturaPropriedade.aspx?estruturaPropriedadeId=<%=EstruturaPropriedadeId%>&tabIndex=Agriculturas" id="EditarA" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
<asp:GridView ID="gridViewAgriculturas" runat="server" 
        ...
        <asp:TemplateField HeaderText="Ações">
            <ItemTemplate>
                <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaPastagem" 
                    NavigateUrl='<%# "~/EditaAgricultura.aspx?estruturaPropriedadeId=" + Request.QueryString["EstruturaPropriedadeId"] + "&a=" + DataBinder.Eval(Container.DataItem,"Id")  %>' />
                <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteEstruturaPropriedadeAgricultura" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteEstruturaPropriedadeAgricultura_Click" OnClientClick="javascript:return perguntaa();" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
