    ...
    <fieldset class="cadastrar_info">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataDesmame" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtPesoMaeDesmame" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static"></asp:TextBox>
                    <span class="style1">(Informar apenas números, separar os decimais por vírgula (não usar pontos como separadores).)</span></div>
                    <asp:customvalidator id="cvPesoMaeDesmame" runat="server" forecolor="Red" errormessage="*" onservervalidate="cvPesoMaeDesmame_ServerValidate"></asp:customvalidator>
                </td>
            </tr>
            </asp:Panel>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataDiagnosticoPrenhez" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataParto" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataEntradaControleLeiteiro" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataEncerramentoLactacao" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="inputDiv"><asp:TextBox ID="txtDataSaidaControle" class="datepick" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
                    <span class="style1">(Informar só os números, no formato DD/MM/AAAA.)</span></div>
