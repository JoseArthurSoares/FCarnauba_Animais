...
{
    public partial class RTaxaMortalidade : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RTaxaMortalidade()
        {
            _PageType = new RTaxaMortalidadeType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            if ((DateTime.TryParse(txtDataInicio.Text, out dateValue) && txtDataInicio.Text != "__/__/____") && (DateTime.TryParse(txtDataFim.Text, out dateValue) && txtDataFim.Text != "__/__/____"))
            {
                ...
                ExibeRelatorio("Relatorios/TaxaMortalidade.rdlc", "IndiceZootecnico", _fCarnaubaFacade.TaxaMortalidade(dataInicio, dataFim, raca, propriedade, categoria));
            }
        }
    }
}