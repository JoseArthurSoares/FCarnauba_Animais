...
{
    public partial class RIndiceFertilidade : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RIndiceFertilidade()
        {
            _PageType = new RIndiceFertilidadeType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/IndiceFertilidade.rdlc", "IndiceFertilidade", _fCarnaubaFacade.IndiceFertilidade(anoPecuario, raca, propriedade));
