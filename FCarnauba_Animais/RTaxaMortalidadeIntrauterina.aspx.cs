...
{
    public partial class RTaxaMortalidadeIntrauterina : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RTaxaMortalidadeIntrauterina()
        {
            _PageType = new RTaxaMortalidadeIntrauterinaType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/TaxaMortalidadeIntrauterina.rdlc", "TaxaMortalidadeIntrauterina", _fCarnaubaFacade.TaxaMortalidadeIntrauterina(anoPecuario, raca, propriedade));
