...
namespace FCarnauba_Animais
{
    public partial class SiteInicio : System.Web.UI.MasterPage
    {
        ...
        //public void UpdateSearchArgument()
        //{
        //    if (Session["parametrosDeBuscaEmFluxoCaixa"] == null)
        //    {
        //        if (Session["searchText"] != null && !String.IsNullOrEmpty(Session["searchText"].ToString()))
        //        {
        //            var textStr = Session["searchText"].ToString();
        ...
        {
            if (e.Item.Value == "Sobre")
            {
                Response.Write("<script>");
                Response.Write("window.open('./img/Sobre.png','', 'toolbar=yes,scrollbars=yes,resizable=yes,top=0,left=600,width=600,height=300')");
                Response.Write("</script>");
            }
        }
    }
