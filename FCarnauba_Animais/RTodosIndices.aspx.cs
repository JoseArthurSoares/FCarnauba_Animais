...
{
    public partial class RTodosIndices : PaginaBase
    {
        public RTodosIndices()
        {
            _PageType = new RTodosIndicesType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/TodosIndices.rdlc", "TodasTaxas", _fCarnaubaFacade.TodasTaxas(anoPecuario, raca, propriedade));
