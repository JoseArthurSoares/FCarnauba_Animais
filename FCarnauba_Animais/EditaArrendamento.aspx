<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEstruturaPropriedade.Master" AutoEventWireup="true" CodeBehind="EditaArrendamento.aspx.cs" Inherits="FCarnauba_Animais.EditaArrendamento" %>
...
<script type="text/javascript" src="./Scripts/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>
    <script type ="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#txtAreaArrendamento").length > 0) $("#txtAreaArrendamento").autoNumeric(numSettings);
            if ($("#txtAreaArrendamento").length > 0) $("#txtAreaArrendamento").autoNumericSet(parseFloat($("#txtAreaArrendamento").val().replace(",", ".")));
        });
    ...
    <uc3:UserControlArrendamento ID="UserControlArrendamento1" runat="server" EstruturaPropriedadeId="<%# id %>" ArrendamentoInd="<%# arr_ind %>" EditMode="true" />
</asp:Content>
