...
{
    public partial class RelatoriosPluviometria : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelatoriosPluviometria()
        {
            _PageType = new RelatoriosPluviometriaType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ExibeRelatorio("Relatorios/Pluviometria.rdlc", "RPluviometria", _fCarnaubaFacade.GetPluviometrias(dataInicio, dataFim, propriedade));
            }
            catch (Exception)
            {
            }
