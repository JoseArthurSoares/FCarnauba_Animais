<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="RMatrizesNBezerros.aspx.cs" Inherits="FCarnauba_Animais.RMatrizesNBezerros" AspCompat="true" %>
...
<div class="barra02" align="left">
			Matrizes Necessárias para Determinado Número de Bezerros</div>
<div id="controles">
<table width="100%">
    <tr>
        ...
        <td style="width: 50px">Nº de Bezerros:</td>
        <td style="width: 200px">
            <asp:DropDownList ID="ddlNBezerros" Name="ddlNBezerros" runat="server" Width="100" ViewStateMode="Enabled">
