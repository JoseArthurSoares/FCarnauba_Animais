...
{
    public partial class GraficoCustosFixos : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public GraficoCustosFixos()
        {
            _PageType = new GraficoCustosFixosType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/GraficoCustosFixos.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemCustosFixos(criterio));
        }
