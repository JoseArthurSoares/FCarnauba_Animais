...
{
    public partial class GraficoCustosVariaveis : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public GraficoCustosVariaveis()
        {
            _PageType = new GraficoCustosVariaveisType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/GraficoCustosVariaveis.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemCustosVariaveis(criterio));
        }
