...
{
    public partial class RRelacaoDesmama : PaginaBase
    {
        public RRelacaoDesmama()
        {
            _PageType = new RRelacaoDesmamaType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelacaoDesmama.rdlc", "RelacaoDesmama", _fCarnaubaFacade.RelacaoDesmama(anoPecuario, raca, propriedade));
