...
{
    public partial class RelatoriosFinanceiroCompleto : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelatoriosFinanceiroCompleto()
        {
            _PageType = new RelatoriosFinanceiroCompletoType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelatorioFinanceiroCompleto.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemItensFinanceirosCompleto(criterio));
        }
