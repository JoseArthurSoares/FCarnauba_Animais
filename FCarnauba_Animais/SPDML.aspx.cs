...
{
    public partial class SPDML : PaginaBase
    {

        public SPDML()
        {
            _PageType = new SPDMLType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/ProducaoDiariaMaxLeite.rdlc", "ProducoesLeiteEnc", _fCarnaubaFacade.ProducoesLeiteEnc(ano, propriedade, raca, "Maxima"));
