...
{
    public partial class RelInvestimento : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelInvestimento()
        {
            _PageType = new RelInvestimentoType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelatorioInvestimento.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemInvestimentos(criterio));
        }
