...
{
    public partial class RTaxaCrescimentoVegetativo : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RTaxaCrescimentoVegetativo()
        {
            _PageType = new RTaxaCrescimentoVegetativoType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            if ((DateTime.TryParse(txtDataInicio.Text, out dateValue) && txtDataInicio.Text != "__/__/____") && (DateTime.TryParse(txtDataFim.Text, out dateValue) && txtDataFim.Text != "__/__/____"))
            {
                ...
                ExibeRelatorio("Relatorios/TaxaCrescimentoVegetativo.rdlc", "IndiceZootecnico", _fCarnaubaFacade.TaxaCrescimentoVegetativo(dataInicio, dataFim, raca, propriedade));
            }
        }
    }
}