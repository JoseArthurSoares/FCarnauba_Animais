<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="RTaxaMortalidade.aspx.cs" Inherits="FCarnauba_Animais.RTaxaMortalidade" AspCompat="true" %>
...
<div class="barra02" align="left">
			Taxa de Mortalidade (TM %)</div>
<div id="controles">
<table width="100%">
    <tr>
        <td style="width: 30px">Período:</td>
        <td style="width: 200px">
            <asp:TextBox ID="txtDataInicio" class="datepick" MaxLength=10 Width=80px runat="server" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox> a <asp:TextBox ID="txtDataFim" class="datepick" MaxLength=10 Width=80px runat="server" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
        </td>
        <td style="width: 30px">Raça:</td>
        <td style="width: 200px">
            <asp:DropDownList ID="ddlRaca" Name="ddlRaca" runat="server" Width="200" ViewStateMode="Enabled">
        ...
        <td style="width: 50px">Categoria:</td>
        <td style="width: 200px">
            <asp:DropDownList ID="ddlCategoria" Name="ddlCategoria" runat="server" Width="200" ViewStateMode="Enabled">
             <asp:ListItem>BEZERROS</asp:ListItem>
             <asp:ListItem>JOVENS</asp:ListItem>
             <asp:ListItem>ADULTOS</asp:ListItem>
            </asp:DropDownList>
        </td>
        <td>
