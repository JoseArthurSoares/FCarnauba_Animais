...
{
    public partial class SPALT : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public SPALT()
        {
            _PageType = new SPALTType();
        }
        ...
        protected void PALT(ParametrosDeBuscaEmAnimais parametrosDeBusca)
        {

            ExibeRelatorio("Relatorios/RankingAcumuladaTotal.rdlc", "RRankingIppIepEr", _fCarnaubaFacade.ConsultaRankingAcumuladaTotal(parametrosDeBusca));
        }
