<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEstruturaPropriedade.Master" AutoEventWireup="true" CodeBehind="EditaBenfeitoria.aspx.cs" Inherits="FCarnauba_Animais.EditaBenfeitoria" AspCompat="true" %>
...
<script type="text/javascript" src="./Scripts/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>
    <script type ="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#txtAreaBenfeitoria").length > 0) $("#txtAreaBenfeitoria").autoNumeric(numSettings);
            if ($("#txtAreaBenfeitoria").length > 0) $("#txtAreaBenfeitoria").autoNumericSet(parseFloat($("#txtAreaBenfeitoria").val().replace(",", ".")));
        });
    ...
    <uc3:UserControlBenfeitoria ID="UserControlBenfeitoria1" runat="server" EstruturaPropriedadeId="<%# id %>" BenfeitoriaInd="<%# b_ind %>" EditMode="true" />
</asp:Content>
