...
{
    public partial class RTaxaDesmame : PaginaBase
    {
        public RTaxaDesmame()
        {
            _PageType = new RTaxaDesmameType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/TaxaDesmame.rdlc", "TaxaDesmame", _fCarnaubaFacade.TaxaDesmame(anoPecuario, raca, propriedade));
