...
<script type="text/javascript" src="./Scripts/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>
    <script type ="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#txtPesoMaeDesmame").length > 0) $("#txtPesoMaeDesmame").autoNumeric(numSettings);
            if ($("#txtPesoMaeDesmame").length > 0) $("#txtPesoMaeDesmame").autoNumericSet(parseFloat($("#txtPesoMaeDesmame").val().replace(",", ".")));
