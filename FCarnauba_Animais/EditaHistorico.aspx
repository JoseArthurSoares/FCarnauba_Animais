<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditaHistorico.aspx.cs" Inherits="FCarnauba_Animais.EditaHistorico" AspCompat="true" %>
...
<script type="text/javascript" src="./Scripts/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>
    ...
    <uc3:UserControlHistorico ID="UserControlHistorico1" runat="server" AnimalId="<%# id %>" HistoricoInd="<%# h_ind %>" EditMode="true" />
</asp:Content>
