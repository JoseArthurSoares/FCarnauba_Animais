<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="RTaxaCrescimentoVegetativo.aspx.cs" Inherits="FCarnauba_Animais.RTaxaCrescimentoVegetativo" AspCompat="true" %>
...
<div class="barra02" align="left">
			Taxa de Crescimento Vegetativo (TCV %)</div>
<div id="controles">
<table width="100%">
    <tr>
        ...
        <td style="width: 200px">
            <asp:DropDownList ID="ddlPropriedade" runat="server" Height="18px" Width="400" onfocus="Javascript:HighlightForm(this,false);" onblur="Javascript:HighlightForm(this,true);">
                </asp:DropDownList>
        </td>
        <td>
