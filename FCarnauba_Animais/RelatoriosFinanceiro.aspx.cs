...
{
    public partial class RelatoriosFinanceiro : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelatoriosFinanceiro()
        {
            _PageType = new RelatoriosFinanceiroType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelatorioFinanceiro.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemItensFinanceiros(criterio));
        }
