...
{
    public partial class SGL : PaginaBase
    {
        public SGL()
        {
            _PageType = new SGLType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/GorduraLeiteLac.rdlc", "ProducoesLeiteEnc", _fCarnaubaFacade.ProducoesLeiteEnc(ano, propriedade, raca, "Gordura"));
