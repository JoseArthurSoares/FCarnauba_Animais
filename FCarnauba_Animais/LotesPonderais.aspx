<%@ Page Title="" Language="C#" MasterPageFile="~/SiteControlePonderal.Master" AutoEventWireup="true" CodeBehind="LotesPonderais.aspx.cs" Inherits="FCarnauba_Animais.LotesPonderais" AspCompat="true" %>
...
<div align="right"><a href="./CadastrarLotePonderal.aspx" id="EditarM" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
    <asp:GridView ID="gridViewLotesPonderais" runat="server" AllowSorting="False" CellPadding="4"
        ...
        BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SLote" HeaderText="LOTE" SortExpression="SLote" ></asp:BoundField>
                            <asp:BoundField DataField="DataControle" HeaderText="DATA DO CONTROLE" SortExpression="DataControle" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Ações">
                                <ItemTemplate>
                                    <asp:HyperLink title="Detalhes" runat="server" Text="<img src='./img/details_icon.gif'>" ID="HyperLink1"
                                        NavigateUrl='<%# "~/DetalhesLotePonderal.aspx?lotePonderalId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaLote" 
                                        NavigateUrl='<%# "~/CadastrarLotePonderal.aspx?act=edit&lotePonderalId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteLotePonderal" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteLotePonderal_Click" OnClientClick="javascript:return pergunta();" />
                                </ItemTemplate>
