...
{
    public partial class RPesagensRebanhos : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RPesagensRebanhos()
        {
            _PageType = new RPesagensRebanhosType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            if ((DateTime.TryParse(txtDataInicio.Text, out dateValue) && txtDataInicio.Text != "__/__/____") && (DateTime.TryParse(txtDataFim.Text, out dateValue) && txtDataFim.Text != "__/__/____"))
            {
                ...
                ParametrosDeBuscaEmLotes parametros = new ParametrosDeBuscaEmLotes();
                ...
                ExibeRelatorio("Relatorios/PesagensRebanhos.rdlc", "RProducaoLeite", _fCarnaubaFacade.GetPesagensRebanho(parametros));
            }
        }
    }
}