...
{
    public partial class RContLeiteiroEnc : PaginaBase
    {

        public RContLeiteiroEnc()
        {
            _PageType = new RContLeiteiroEncType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/ContLeiteiroRebanhoEnc.rdlc", "ProducoesLeiteEnc", _fCarnaubaFacade.ProducoesLeiteEnc(ano, propriedade, raca));
