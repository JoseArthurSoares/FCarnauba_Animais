...
{
    public partial class RelDespesa : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelDespesa()
        {
            _PageType = new RelDespesaType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelDespesa.rdlc", "InformacoesFinanceiras", _fCarnaubaFacade.ObtemListaInformacoesFinanceiras(criterio));
        }
