...
{
    public partial class SKGIEP : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public SKGIEP()
        {
            _PageType = new SKGIEPType();
        }
        ...
        protected void KGIEP(ParametrosDeBuscaEmAnimais parametrosDeBusca)
        {

            ExibeRelatorio("Relatorios/RankingKgIep.rdlc", "RRankingIppIepEr", _fCarnaubaFacade.ConsultaRankingKgIep(parametrosDeBusca));
        }
