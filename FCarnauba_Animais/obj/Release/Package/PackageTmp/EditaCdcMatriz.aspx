<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCDC.Master" AutoEventWireup="true" CodeBehind="EditaCdcMatriz.aspx.cs" Inherits="FCarnauba_Animais.EditaCdcMatriz" AspCompat="true" %>
...
<script type ="text/javascript" src="Scripts/jquery-1.4.1.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        if ($("#txtDataCdcEfetiva").length > 0) $("#txtDataCdcEfetiva").mask("99/99/9999");
    ...
    <uc3:UserControlCdcMatrizes ID="UserControlCdcMatrizes1" runat="server" CdcId="<%# id %>" CdcMatrizInd="<%# m_ind %>" EditMode="true" />
</asp:Content>
