            ...
            jq191("#tabs").tabs(
             {
                 activate: function (event, ui) {
                     ...
                     if (newId == "pastagem-tab" || newId == "agricultura-tab" || newId == "estruturapropriedade-tab") {
                         //jq191("#EditImageButton").hide();
                     } else {
    ...
    <div id="tabs" style="margin-top:20px">
        ...
        <fieldset class="cadastrar_info">
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="15%" class="rotulo">Palma Forrageira:</td>
                    <td width="85%" class="dado"><asp:Label ID="lblPalmaForrageira" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
