<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEstruturaPropriedade.Master" AutoEventWireup="true" CodeBehind="EstruturasPropriedades.aspx.cs" Inherits="FCarnauba_Animais.EstruturasPropriedades" AspCompat="true" %>
...
<div class="barra02" align="left">
			Informações das Propriedades</div>
...
<div align="right"><a href="./CadastrarEstruturaPropriedade.aspx" id="AdicionaP" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
<asp:GridView ID="gridViewEstruturasPropriedades" runat="server" AllowSorting="False" CellPadding="4"
        ...
        BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TotalPastagens" HeaderText="TOTAL PASTAGENS" SortExpression="TotalPastagens" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="TotalAgricultura" HeaderText="TOTAL AGRICULTURAS" SortExpression="TotalAgricultura" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="Benfeitorias" HeaderText="BENFEITORIAS" SortExpression="Benfeitorias" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="Arrendamentos" HeaderText="ARRENDAMENTOS" SortExpression="Arrendamentos" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="Reserva" HeaderText="RESERVA" SortExpression="Reserva" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="PalmaForrageira" HeaderText="PALMA FORRAGEIRA" SortExpression="PalmaForrageira" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:BoundField DataField="Outras" HeaderText="OUTRAS" SortExpression="Outras" DataFormatString="{0:N2}"></asp:BoundField>
                            <asp:TemplateField HeaderText="Ações">
                                <ItemTemplate>
                                    <asp:HyperLink title="Detalhes" runat="server" Text="<img src='./img/details_icon.gif'>" ID="HyperLink1"
                                        NavigateUrl='<%# "~/DetalhesEstruturaPropriedade.aspx?estruturaPropriedadeId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaControlePluviometrico" 
                                        NavigateUrl='<%# "~/CadastrarEstruturaPropriedade.aspx?act=edit&estruturaPropriedadeId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteEstruturaPropriedade" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteEstruturaPropriedade_Click" OnClientClick="javascript:return pergunta();" />
                                </ItemTemplate>
