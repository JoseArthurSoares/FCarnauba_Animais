...
<table width="100%">
    <tr>
        ...
        <td style="width: 200px">
            <asp:TextBox ID="txtDataInicio" MaxLength=10 Width=80px runat="server" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox> a <asp:TextBox ID="txtDataFim" MaxLength=10 Width=80px runat="server" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
        </td>
