...
<div id="tabs" style="margin-top:20px">
        ...
        <tr>
	        ...
	        <td>
		        <div class="inputDiv"><asp:TextBox ID="txtDataLote" runat="server" onfocus="Javascript:ValidateForm(this,false,RetTrue);" onblur="Javascript:ValidateForm(this,true,RetTrue);" ClientIDMode="Static" placeholder="__/__/____"></asp:TextBox>
