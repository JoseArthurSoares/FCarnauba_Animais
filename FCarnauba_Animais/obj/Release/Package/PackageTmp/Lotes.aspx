<%@ Page Title="" Language="C#" MasterPageFile="~/SiteControleLeiteiro.Master" AutoEventWireup="true" CodeBehind="Lotes.aspx.cs" Inherits="FCarnauba_Animais.Lotes" AspCompat="true"%>
...
<div align="right"><a href="./CadastrarLote.aspx" id="EditarM" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
    <asp:GridView ID="gridViewLotes" runat="server" AllowSorting="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Ações">
                                <ItemTemplate>
                                    <asp:HyperLink title="Detalhes" runat="server" Text="<img src='./img/details_icon.gif'>" ID="HyperLink1"
                                        NavigateUrl='<%# "~/DetalhesLote.aspx?loteId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnEditaLote" 
                                        NavigateUrl='<%# "~/CadastrarLote.aspx?act=edit&loteId=" + DataBinder.Eval(Container.DataItem,"Id") %>' />
                                        <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteLote" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteLote_Click" OnClientClick="javascript:return pergunta();" />
                                </ItemTemplate>
