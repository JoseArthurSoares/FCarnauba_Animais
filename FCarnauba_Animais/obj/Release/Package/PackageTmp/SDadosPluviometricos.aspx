<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="SDadosPluviometricos.aspx.cs" Inherits="FCarnauba_Animais.SDadosPluviometricos" AspCompat="true" %>
...
<div class="barra02" align="left">
			Sumário Dados Pluviométricos</div>
<div id="controles">
<table width="100%" >
    <tr>
        <td style="width: 50px">Propriedade:</td>
        <td style="width: 200px">
            <asp:DropDownList ID="ddlProprieddade" Name="ddlPropriedade" runat="server" Width="400" ViewStateMode="Enabled">
            </asp:DropDownList>
        </td>
        <td>
