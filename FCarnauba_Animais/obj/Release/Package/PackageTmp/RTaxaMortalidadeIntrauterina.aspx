<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="RTaxaMortalidadeIntrauterina.aspx.cs" Inherits="FCarnauba_Animais.RTaxaMortalidadeIntrauterina" AspCompat="true" %>
...
<div class="barra02" align="left">
			Taxa de Mortalidade Intrauterina (TMI)</div>
            <div id="controles">
<table width="100%">
    <tr>
        <td style="width: 80px">Ano Pecuário:</td>
        <td style="width: 100px">
            <asp:DropDownList ID="ddlAnoPecuario" runat="server" Height="18px" Width="100" onfocus="Javascript:HighlightForm(this,false);" onblur="Javascript:HighlightForm(this,true);">
                </asp:DropDownList>
        </td>
