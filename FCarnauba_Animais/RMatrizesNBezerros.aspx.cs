...
{
    public partial class RMatrizesNBezerros : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RMatrizesNBezerros()
        {
            _PageType = new RMatrizesNBezerrosType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            double nBezerros = Convert.ToDouble(ddlNBezerros.SelectedValue);
            ...
            if ((DateTime.TryParse(txtDataInicio.Text, out dateValue) && txtDataInicio.Text != "__/__/____") && (DateTime.TryParse(txtDataFim.Text, out dateValue) && txtDataFim.Text != "__/__/____"))
            {
                ...
                ExibeRelatorio("Relatorios/MatrizesNBezerros.rdlc", "IndiceZootecnico", _fCarnaubaFacade.MatrizesNBezerros(dataInicio, dataFim, raca, propriedade, nBezerros));
            }
        }
    }
}