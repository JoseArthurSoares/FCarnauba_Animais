<%@ Page Title="" Language="C#" MasterPageFile="~/SiteControlePonderal.Master" AutoEventWireup="true" CodeBehind="DetalhesMensuracao.aspx.cs" Inherits="FCarnauba_Animais.DetalhesMensuracao" AspCompat="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset class="cadastrar_info">
        ...
        <tr>
            ...
            <td width="80%" class="dado">
                <asp:Label ID="lblPesoMaeDesmame" runat="server"></asp:Label>
            </td>
        </tr>
        </table>
    </fieldset>
