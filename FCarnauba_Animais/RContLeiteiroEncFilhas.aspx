<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInicio.Master" AutoEventWireup="true" CodeBehind="RContLeiteiroEncFilhas.aspx.cs" Inherits="FCarnauba_Animais.RContLeiteiroEncFilhas" AspCompat="true" %>
...
<div class="barra02" align="left">
			Relatório Produção de Leite das Filhas</div>
            <div id="controles">
<table width="100%">
    <tr>
        ...
        <td style="width: 50px">Animal:</td>
        <td style="width: 300px">
            <asp:DropDownList ID="ddlAnimal" runat="server" Height="18px" Width="300" onfocus="Javascript:HighlightForm(this,false);" onblur="Javascript:HighlightForm(this,true);">
                </asp:DropDownList>
        </td>
        <td>
