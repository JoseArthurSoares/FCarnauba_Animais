...
{
    public partial class RelLucroFazenda : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelLucroFazenda()
        {
            _PageType = new RelLucroFazendaType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelLucroFazenda.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemBalancoFinanceiro(criterio));
        }
