...
{
    public partial class GraficoBalancoFinanceiro : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public GraficoBalancoFinanceiro()
        {
            _PageType = new GraficoBalancoFinanceiroType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/GraficoBalancoFinanceiro.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemBalancoFinanceiro(criterio));
        }
