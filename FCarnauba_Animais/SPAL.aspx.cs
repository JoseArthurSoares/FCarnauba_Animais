...
{
    public partial class SPAL : PaginaBase
    {

        public SPAL()
        {
            _PageType = new SPALType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/ProducaoAcumuladaLeiteLac.rdlc", "ProducoesLeiteEnc", _fCarnaubaFacade.ProducoesLeiteEnc(ano, propriedade, raca, "Acumulado"));
