...
{
    public partial class SPL : PaginaBase
    {
        public SPL()
        {
            _PageType = new SPLType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/ProteinaLeiteLac.rdlc", "ProducoesLeiteEnc", _fCarnaubaFacade.ProducoesLeiteEnc(ano, propriedade, raca, "Proteina"));
