<%@ Page Title="" Language="C#" MasterPageFile="~/SiteFluxoCaixa.Master" AutoEventWireup="true" CodeBehind="RelatoriosVendasAnimais.aspx.cs" Inherits="FCarnauba_Animais.RelatoriosVendasAnimais" AspCompat="true" %>
...
<uc2:Mensagem ID="mensagem" runat="server" />
    <tr>
        <td>Cliente:</td>
        <td>
            <asp:DropDownList ID="ddlCliente" Name="ddlCliente" runat="server" ViewStateMode="Enabled">
            </asp:DropDownList>
        </td>
        <td>Período:</td>
        <td>                
