<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Animais.aspx.cs" Inherits="FCarnauba_Animais.Animais" AspCompat="true" %>
...
<div id="dialog-modal" title="Busca Avançada" class="jqmodal">
    ...
    <div align="right"><a href="./CadastrarAnimal.aspx" id="AdicionaA" title="Adicionar"><img src="./img/adicionar.png" /></a></div><br>
        ...
        BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Ações">
                                <ItemTemplate>
                                    <asp:HyperLink title="Detalhes" runat="server" Text="<img src='./img/details_icon_ac.png'>" ID="HyperLink1"
                                        NavigateUrl='<%# "~/DetalhesAnimal.aspx?animalId=" + DataBinder.Eval(Container.DataItem,"Id") %>' CssClass="link_acoes" />
                                    <asp:HyperLink title="Editar" runat="server" Text="<img src='./img/edit_icon.gif'>" ID="btnAnimal" 
                                        NavigateUrl='<%# "~/CadastrarAnimal.aspx?act=edit&animalId=" + DataBinder.Eval(Container.DataItem,"Id") %>' CssClass="link_acoes" />
                                    <asp:LinkButton title="Remover" runat="server" Text="<img src='./img/delete_icon.png'>" ID="btnDeleteAnimal" CommandArgument='<%#Bind("Id") %>' OnClick="btnDeleteAnimal_Click" OnClientClick="javascript:return pergunta();" CssClass="link_acoes" />
                                    <input type="image" src="./img/pdf_icon.png" name="RPI2"  value="RIL" title="RPI"  onclick="javascript:window.open('RelatoriosControlePonderal.aspx?animalId=<%# DataBinder.Eval(Container.DataItem,"Id") %>','_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=300,width=1050,height=750');return false;" >
                                    <input type="image" src="./img/pdf_icon.png" name="RIL2"  value="RIL" title="RIL"  onclick="javascript:window.open('RelatoriosControleLeiteiro.aspx?matrizId=<%# DataBinder.Eval(Container.DataItem,"Id") %>','_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=300,width=1050,height=750');return false;" >
                                    <input type="image" src="./img/pdf_icon.png"  value="Ficha Individual" title="Ficha Individual"  onclick="javascript:window.open('RelatorioIndividual.aspx?id=<%# DataBinder.Eval(Container.DataItem,"Id") %>','_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=300,width=1050,height=750');return false;" >
                                    <input type="image" src="./img/arvoregenealogica.png"  value="Árvore Genealógica" title="Árvore Genealógica"  onclick="javascript:window.open('Arvore.aspx?id=<%# DataBinder.Eval(Container.DataItem,"Id") %>','_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=300,width=1050,height=750');return false;" >
                                    <input type="image" src="./img/cadastro.png"  value="Cadastrar Monitoramento" title="Cadastrar Monitoramento"  onclick="alerta()" >
                                    <input type="image" src="./img/monitoramento.png"  value="Monitoramento" title="Monitoramento"  onclick="alerta()" >
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
    </asp:GridView>
