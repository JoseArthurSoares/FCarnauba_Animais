...
{
    public partial class RelCusto : PaginaBase
    {
        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public RelCusto()
        {
            _PageType = new RelCustoType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/RelatorioCusto.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemCustos(criterio));
        }
