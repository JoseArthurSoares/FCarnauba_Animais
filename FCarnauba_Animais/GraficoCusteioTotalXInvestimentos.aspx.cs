...
{
    public partial class GraficoCusteioTotalXInvestimentos : PaginaBase
    {

        private FCarnaubaFacade _fCarnaubaFacade = new FCarnaubaFacade();

        public GraficoCusteioTotalXInvestimentos()
        {
            _PageType = new GraficoCusteioTotalXInvestimentosType();
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ExibeRelatorio("Relatorios/GraficoCusteioTotalXInvestimentos.rdlc", "RItemFinanceiro", _fCarnaubaFacade.ObtemCusteioTotalXInvestimentos(criterio));
        }
