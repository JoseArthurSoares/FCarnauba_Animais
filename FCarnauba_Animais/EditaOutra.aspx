<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEstruturaPropriedade.Master" AutoEventWireup="true" CodeBehind="EditaOutra.aspx.cs" Inherits="FCarnauba_Animais.EditaOutra" %>
...
<script type="text/javascript" src="./Scripts/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>
    <script type ="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#txtAreaOutra").length > 0) $("#txtAreaOutra").autoNumeric(numSettings);
            if ($("#txtAreaOutra").length > 0) $("#txtAreaOutra").autoNumericSet(parseFloat($("#txtAreaOutra").val().replace(",", ".")));
        });
    ...
    <uc3:UserControlOutra ID="UserControlOutra1" runat="server" EstruturaPropriedadeId="<%# id %>" OutraInd="<%# o_ind %>" EditMode="true" />
</asp:Content>
