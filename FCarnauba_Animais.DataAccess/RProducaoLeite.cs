...
{
    [Serializable]
    public class RProducaoLeite
    {
        int _Controle;
        int _OrdemParto;
        int _LactacaoControlada;
        int _LactacaoControladaInv;
        long _Id;
        string _IdMatriz;
        string _NomeMatriz;
        string _RgdMatriz;
        DateTime _DataNascimentoMatriz;
        DateTime _DataNascimentoCria;
        string _IdCria;
        string _IdadeParto;
        int _DiasLactacao;
        double _Esgota;
        ...
        double _ProducaoAcumuladaTotal;
        bool _SairControle;
        ...
        public int LactacaoControlada
        {
            get
            {
                return _LactacaoControlada;
            }
            set
            {
                _LactacaoControlada = value;
            }
        }

        public int LactacaoControladaInv
        {
            get
            {
                return _LactacaoControladaInv;
            }
            set
            {
                _LactacaoControladaInv = value;
            }
        }
        ...
        public DateTime DataNascimentoCria
        {
            get
            {
                return _DataNascimentoCria;
            }
            set
            {
                _DataNascimentoCria = value;
            }
        }
        ...
        public double ProducaoAcumuladaTotal
        {
            get
            {
                return _ProducaoAcumuladaTotal;
            }
            set
            {
                _ProducaoAcumuladaTotal = value;
            }
        }
